...
# Description : Script to reorder circleator format by phylogeny.
...
df5=df.iloc[:, len(qindexes)+4:len(qindexes)+15]

df6=concat([df4,df5], axis=1)

df7=concat([df6,df3],axis=1)
df8=concat([df7,df.iloc[:,-3:]], axis=1)
df8=df8.fillna('NA')
#save reordered file
